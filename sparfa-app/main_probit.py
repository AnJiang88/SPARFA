...
import solution_probit
import prediction_probit
import os
import numpy as np
import random
import pandas as pd
...
if __name__ == '__main__':
    ...
    print(f"The training dataset has {observed_response_percentage * (1 - test_size):.1%} of learner responses observed.")
    ...
    for initIterator in range(0, numOfInitialization):
        ...
        solutionObj = solution_probit.Solution(Y_train, Q, N, K)  # object = filename.classname(variables)
...
########################################################################
    predictionObj = prediction_probit.Prediction(Y_train, W, C, Q, N, K)
    student_number = 5
